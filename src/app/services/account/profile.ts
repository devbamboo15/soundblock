...
export class ProfileService {
    ...
    uploadAvatar(file) {
        ...
        return this.http.post<any>(`user/avatar`, formData).pipe(map(res => {
            console.log(res);
            return res.data;
        }));
    }
    ...
    getAddress(user?, perPage?) {
        ...
        return this.http.get<any>(`user/profile/address`, { params }).pipe(map(res => {
            return res.data;
        }));
    }
    ...
    getEmail(user?, perPage?) {
        ...
        return this.http.get<any>(`user/profile/email`, { params }).pipe(map(res => {
            return res.data;
        }));
    }
    ...
    getPhone(user?, perPage?) {
        ...
        return this.http.get<any>(`user/profile/phone`, { params }).pipe(map(res => {
            return res.data;
        }));
    }
    ...
    getPaypal(user?, perPage?) {
        ...
        return this.http.get<any>(`user/profile/paypal`, { params }).pipe(map(res => {
            return res.data;
        }));
    }
    ...
    getBank(user?, perPage?) {
        ...
        return this.http.get<any>(`user/profile/bank`, { params }).pipe(map(res => {
            return res.data;
        }));
    }
